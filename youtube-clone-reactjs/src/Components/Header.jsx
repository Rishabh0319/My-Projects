...
// Contest Api For Data Transmition
...
const Header = () => {
  ...
  // SearchBar Query Handller Function
      ...
      <div className="flex items-center">
        <div className='hidden md:flex items-center'>
          ...
          <div className='flex h-8 w-8 overflow-hidden rounded-full md:ml-4'>
            <img src='https://xsgames.co/randomusers/assets/avatars/male/55.jpg' alt='profile'/>
          </div>
        </div>
      </div>
    </div>
