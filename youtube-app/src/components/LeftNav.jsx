...
const LeftNav = () => {
    ...
    return (
        <div className='md:block w-[240px] overflow-y-auto m-0 h-[calc(100vh-56px)] py-4 bg-black bg-fixed md:relative z-10 translate-x-[-240px] md:translate-x-0 transition-all'>
