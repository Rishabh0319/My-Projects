...
const Header = () => {
    ...
    // access STATE Data from Context
    const { loading, mobileMenu, setMobileMenu } = useContext(Context);

    // navigator Hook from RRD
    ...
    return (
        <div className='sticky top-0 p-3 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-white dark:bg-black'>
            ...
            <div className='flex h-5 item-center'>
                ...
                <Link to="/" className='flex h-5 items-center'>
                    <img src={ytLogo} alt="Youtube" className='h-full hidden dark:md:block cursor-pointer' />
